...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i>欢迎您，<?php echo $_SESSION["username"]?><i
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="#"><i class="fa fa-edit fa-fw"></i>用户管理<span
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12 ">
					<h3>All Videos Management</h3>
				</div>
			</div>
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a href="allvideos.php">全部视频【】</a></li>
				<li role="presentation"><a href="successvideos.php">发布成功【】</a></li>
...
$sql = "select * from videoinfo"; // sql语句
$result = doresult($sql);
while (! ! $rows = dolists($result)) {
    echo " 
    <div class='row'style='text-align:center;margin:10px;'>
                    <div class='col-lg-1'style='text-align:left;'><input type='checkbox' aria-label=''></div>
    				...
    				<div class='col-lg-1'><h5>$rows[time]</h5></div>
    				<div class='col-lg-1'><h5>$rows[situation]</h5></div>
    				<div class='col-lg-3'>
    				    <div class='row'>
...
?>
        ...
        -->
		<ul class="list-group">
			<li class="list-group-item"><span class="badge">All Videos</span>All
				Videos</li>
		</ul>

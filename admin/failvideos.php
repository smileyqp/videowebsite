...
$sql = "select * from videoinfo where situation=0"; // sql语句
$result = doresult($sql);
...
?>
        ...
        -->
		<ul class="list-group">
			<li class="list-group-item"><span class="badge">Fail Videos</span>Fail
				Videos</li>
		</ul>
